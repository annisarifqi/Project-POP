...
public class ListGedung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_gedung);
        ...
        RecyclerViewAdapter adapter = new RecyclerViewAdapter(ListGedung.this);
